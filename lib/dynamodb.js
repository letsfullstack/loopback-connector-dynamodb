...
DynamoDB.prototype.define = function (descr) {
  ...
  /*
    Add keyType = 'hash' for idInjection: true option in model.
   */
  if (properties.id !== undefined && properties.id.keyType === undefined) {
